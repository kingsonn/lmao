...
$(document).ready(function () {
                $(".custom_box_Tabs_btn").click(function () {

                $(".custom_box_Tabs_btn").removeClass("custom_box_Tabs_btn_active");

                $(this).addClass("custom_box_Tabs_btn_active");
  ...
  //accordion
  $(function() {
    $('.faqs-content-div-heading-name').click(function(j) {
      
      var dropDown = $(this).closest('.faq-item-list').find('.inner');
      $(this).closest('.faqs-content-div').find('.inner').not(dropDown).slideUp();
      
      if ($(this).hasClass('active')) {
        $(this).removeClass('active');
      } else {
        $(this).closest('.faqs-content-div').find('.faqs-content-div-heading-name.active').removeClass('active');
...
function byop () {
  // On start addToCartButton should be hidden
  $("#addToCartButton").hide();

  // On Click of Button Show Select/Dropdown
  $(".select-product").click(function(){
    $("#1").css({"visibility": "visible"});
  });
  $(".select-product2").click(function(){
    $("#2").css({"visibility": "visible"});
  });
  $(".select-product3").click(function(){
    $("#3").css({"visibility": "visible"});
  });
  $(".select-product4").click(function(){
    $("#4").css({"visibility": "visible"});
  });
  $(".select-product5").click(function(){
    $("#5").css({"visibility": "visible"});
  });
  $(".select-product6").click(function(){
  ...
  // Quantities of Each Item : Default 1
  var quantity = 1;
  var quantity2 = 1;
  var quantity3 = 1;
  var quantity4 = 1;
  ...
  // Selected Flag to check all select inputs are selected : Default false
  var selected = false;
  var selected2 = false;
  var selected3 = false;
  var selected4 = false;
  ...
  var IMG_URL =
    "https://getawhey.in/wp-content/uploads/2022/01/";

  // Function to get value of each select field and apply it to href
  $("#1").change(function () {
    val = $(this).val();

    // Add image according to selected values
    if (val == 594) {
      $(".box_details_img1").attr("src", `${IMG_URL}2.png`);
    } else if (val == 592) {
      $(".box_details_img1").attr("src", `${IMG_URL}10.png`);
    } else if (val == 581) {
      $(".box_details_img1").attr("src", `${IMG_URL}12.png`);
    } else if (val == 790) {
      $(".box_details_img1").attr("src", `${IMG_URL}1.png`);
    } else if (val == 472) {
      $(".box_details_img1").attr("src", `${IMG_URL}4.png`);
    } else if (val == 576) {
      $(".box_details_img1").attr("src", `${IMG_URL}3.png`);
    } else if (val == 557) {
      $(".box_details_img1").attr("src", `${IMG_URL}5.png`);
    }


    // Remove duplicated from values and add them in array
    if ($.inArray(val, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4, val5, val6);

    // On every select find the occurrence of value in selected values 
    var occurrencesOf = (number, numbers) =>
      numbers.reduce(
    ...
    // Then compare quantity of each values with selected values
    quantity = occurrencesOf(val, [val, val2, val3, val4, val5, val6]);
    quantity2 = occurrencesOf(val2, [val, val2, val3, val4, val5, val6]);
    quantity3 = occurrencesOf(val3, [val, val2, val3, val4, val5, val6]);
    quantity4 = occurrencesOf(val4, [val, val2, val3, val4, val5, val6]);
    quantity5 = occurrencesOf(val5, [val, val2, val3, val4, val5, val6]);
    quantity6 = occurrencesOf(val6, [val, val2, val3, val4, val5, val6]);
    console.log(
      quantity,
      quantity2,
      quantity3,
    ...
    // Add selectedVal & selectedQuantity to addValuesToLink which adds them to link
    addValuesToLink(selectedVal, selectedQuantity);

    // Once the values & quantity's is added to hyperlink then selected = true
    selected = true;

    // Add all the selected in showButton function
    showButton(selected, selected2, selected3, selected4, selected5, selected6);
  });
  ...
  $("#2").change(function () {
    ...
    if (val2 == 594) {
      $(".box_details_img2").attr("src", `${IMG_URL}2.png`);
    } else if (val2 == 592) {
      $(".box_details_img2").attr("src", `${IMG_URL}10.png`);
    } else if (val2 == 581) {
      $(".box_details_img2").attr("src", `${IMG_URL}12.png`);
    } else if (val2 == 790) {
      $(".box_details_img2").attr("src", `${IMG_URL}1.png`);
    } else if (val2 == 472) {
      $(".box_details_img2").attr("src", `${IMG_URL}4.png`);
    } else if (val2 == 576) {
      $(".box_details_img2").attr("src", `${IMG_URL}3.png`);
    } else if (val2 == 557) {
      $(".box_details_img2").attr("src", `${IMG_URL}5.png`);
    }

    if ($.inArray(val2, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4, val5, val6);
  ...
  $("#3").change(function () {
    ...
    if (val3 == 594) {
      $(".box_details_img3").attr("src", `${IMG_URL}2.png`);
    } else if (val3 == 592) {
      $(".box_details_img3").attr("src", `${IMG_URL}10.png`);
    } else if (val3 == 581) {
      $(".box_details_img3").attr("src", `${IMG_URL}12.png`);
    } else if (val3 == 790) {
      $(".box_details_img3").attr("src", `${IMG_URL}1.png`);
    } else if (val3 == 472) {
      $(".box_details_img3").attr("src", `${IMG_URL}4.png`);
    } else if (val3 == 576) {
      $(".box_details_img3").attr("src", `${IMG_URL}3.png`);
    } else if (val3 == 557) {
      $(".box_details_img3").attr("src", `${IMG_URL}5.png`);
    }

    if ($.inArray(val3, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4, val5, val6);
  ...
  $("#4").change(function () {
    ...
    if (val4 == 594) {
      $(".box_details_img4").attr("src", `${IMG_URL}2.png`);
    } else if (val4 == 592) {
      $(".box_details_img4").attr("src", `${IMG_URL}10.png`);
    } else if (val4 == 581) {
      $(".box_details_img4").attr("src", `${IMG_URL}12.png`);
    } else if (val4 == 790) {
      $(".box_details_img4").attr("src", `${IMG_URL}1.png`);
    } else if (val4 == 472) {
      $(".box_details_img4").attr("src", `${IMG_URL}4.png`);
    } else if (val4 == 576) {
      $(".box_details_img4").attr("src", `${IMG_URL}3.png`);
    } else if (val4 == 557) {
      $(".box_details_img4").attr("src", `${IMG_URL}5.png`);
    }

    if ($.inArray(val4, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4, val5, val6);
  ...
  $("#5").change(function () {
    ...
    if (val5 == 594) {
      $(".box_details_img5").attr("src", `${IMG_URL}2.png`);
    } else if (val5 == 592) {
      $(".box_details_img5").attr("src", `${IMG_URL}10.png`);
    } else if (val5 == 581) {
      $(".box_details_img5").attr("src", `${IMG_URL}12.png`);
    } else if (val5 == 790) {
      $(".box_details_img5").attr("src", `${IMG_URL}1.png`);
    } else if (val5 == 472) {
      $(".box_details_img5").attr("src", `${IMG_URL}4.png`);
    } else if (val5 == 576) {
      $(".box_details_img5").attr("src", `${IMG_URL}3.png`);
    } else if (val5 == 557) {
      $(".box_details_img5").attr("src", `${IMG_URL}5.png`);
    }

    if ($.inArray(val5, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4, val5, val6);
  ...
  $("#6").change(function () {
    ...
    if (val6 == 563) {
      $(".box_details_img6").attr("src", `${IMG_URL}9.png`);
    } else if (val6 == 572) {
      $(".box_details_img6").attr("src", `${IMG_URL}6.png`);
    } else if (val6 == 566) {
      $(".box_details_img6").attr("src", `${IMG_URL}8.png`);
    } else if (val6 == 1377) {
      $(".box_details_img6").attr("src", `${IMG_URL}7.png`);
    } else if (val6 == 584) {
      $(".box_details_img6").attr("src", `${IMG_URL}11.png`);
    }

    if ($.inArray(val6, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4, val5, val6);
  ...
  // Function to add values to link
  function addValuesToLink(selectedVal, selectedQuantity) {
    $("a#link").attr(
      "href",
      `https://getawhey.in/cart/?add-to-cart=1483${
        val ? `&quantity[${val}]=${quantity}` : ""
      }${val2 ? `&quantity[${val2}]=${quantity2}` : ""}${
        val3 ? `&quantity[${val3}]=${quantity3}` : ""
      }${val4 ? `&quantity[${val4}]=${quantity4}` : ""} ${
        val5 ? `&quantity[${val5}]=${quantity5}` : ""
      }${val6 ? `&quantity[${val6}]=${quantity6}` : ""}
      `
    );
  }

  // once all selected are true show add to cart button
  function showButton(
    selected,
    selected2,
    selected3,
    ...
    if (
      ...
      // console.log(selected,selected2,selected3,selected4,selected5,selected6);
    }
  }
};
...
function byopKeto () {
  // On start addToCartButton should be hidden
  $("#addToCartButton-keto").hide();

  // // On Click of Button Show Select/Dropdown
  $(".select-product-keto").click(function(){
    $("#1-keto").css({"visibility": "visible"});
  });
  $(".select-product-keto2").click(function(){
    $("#2-keto").css({"visibility": "visible"});
  });
  $(".select-product-keto3").click(function(){
    $("#3-keto").css({"visibility": "visible"});
  });
  $(".select-product-keto4").click(function(){
    $("#4-keto").css({"visibility": "visible"});
  });
  ...
  // Function to get value of each select field and apply it to href
  $("#1-keto").change(function () {
    val = $(this).val();

    // Add image according to selected values
    if (val == 563) {
        $(".box_details_img1-keto").attr("src", `${IMG_URL}9.png`);
      } else if (val == 572) {
        $(".box_details_img1-keto").attr("src", `${IMG_URL}6.png`);
      } else if (val == 566) {
        $(".box_details_img1-keto").attr("src", `${IMG_URL}8.png`);
      } else if (val == 1377) {
        $(".box_details_img1-keto").attr("src", `${IMG_URL}7.png`);
      } 


    // Remove duplicated from values and add them in array
    if ($.inArray(val, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4);

    // On every select find the occurrence of value in selected values 
    let occurrencesOf = (number, numbers) =>
      numbers.reduce(
        (counter, currentNumber) =>
          number === currentNumber ? counter + 1 : counter,
        0
    ...
    // Then compare quantity of each values with selected values
    quantity = occurrencesOf(val, [val, val2, val3, val4]);
    quantity2 = occurrencesOf(val2, [val, val2, val3, val4]);
    quantity3 = occurrencesOf(val3, [val, val2, val3, val4]);
    quantity4 = occurrencesOf(val4, [val, val2, val3, val4]);
    ...
    // Add selectedVal & selectedQuantity to addValuesToLink2 which adds them to link
    addValuesToLink2(selectedVal, selectedQuantity);

    // Once the values & quantity's is added to hyperlink then selected = true
    selected = true;

    // Add all the selected in showButton2 function
    showButton2(selected, selected2, selected3, selected4);
  });

  $("#2-keto").change(function () {
    val2 = $(this).val();

    if (val2 == 563) {
        $(".box_details_img2-keto").attr("src", `${IMG_URL}9.png`);
      } else if (val2 == 572) {
        $(".box_details_img2-keto").attr("src", `${IMG_URL}6.png`);
      } else if (val2 == 566) {
        $(".box_details_img2-keto").attr("src", `${IMG_URL}8.png`);
      } else if (val2 == 1377) {
        $(".box_details_img2-keto").attr("src", `${IMG_URL}7.png`);
      } 
    if ($.inArray(val2, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4);
  ...
  $("#3-keto").change(function () {
    val3 = $(this).val();

    if (val3 == 563) {
        $(".box_details_img3-keto").attr("src", `${IMG_URL}9.png`);
      } else if (val3 == 572) {
        $(".box_details_img3-keto").attr("src", `${IMG_URL}6.png`);
      } else if (val3 == 566) {
        $(".box_details_img3-keto").attr("src", `${IMG_URL}8.png`);
      } else if (val3 == 1377) {
        $(".box_details_img3-keto").attr("src", `${IMG_URL}7.png`);
      } 
  ...
  $("#4-keto").change(function () {
    val4 = $(this).val();

    if (val4 == 563) {
        $(".box_details_img4-keto").attr("src", `${IMG_URL}9.png`);
      } else if (val4 == 572) {
        $(".box_details_img4-keto").attr("src", `${IMG_URL}6.png`);
      } else if (val4 == 566) {
        $(".box_details_img4-keto").attr("src", `${IMG_URL}8.png`);
      } else if (val4 == 1377) {
        $(".box_details_img4-keto").attr("src", `${IMG_URL}7.png`);
      } 
  ...
  // Function to add values to link
  function addValuesToLink2(selectedVal, selectedQuantity) {
    $("a#link-keto").attr(
      "href",
      `https://getawhey.in/cart/?add-to-cart=1483${
        val ? `&quantity[${val}]=${quantity}` : ""
...
function byopPo10 () {
  // On start addToCartButton should be hidden
  $("#addToCartButton-po10").hide();

  // // On Click of Button Show Select/Dropdown
  $(".select-product-po10").click(function(){
    $("#1-po10").css({"visibility": "visible"});
  });
  $(".select-product-po10-2").click(function(){
    $("#2-po10").css({"visibility": "visible"});
  });
  $(".select-product-po10-3").click(function(){
    $("#3-po10").css({"visibility": "visible"});
  });
  $(".select-product-po10-4").click(function(){
    $("#4-po10").css({"visibility": "visible"});
  });
  $(".select-product-po10-5").click(function(){
    $("#5-po10").css({"visibility": "visible"});
  });
  ...
  // Function to get value of each select field and apply it to href
  $("#1-po10").change(function () {
    val = $(this).val();

    // Add image according to selected values
    if (val == 594) {
      $(".box_details_img1-po10").attr("src", `${IMG_URL}2.png`);
    } else if (val == 592) {
      $(".box_details_img1-po10").attr("src", `${IMG_URL}10.png`);
    } else if (val == 581) {
      $(".box_details_img1-po10").attr("src", `${IMG_URL}12.png`);
    } else if (val == 790) {
      $(".box_details_img1-po10").attr("src", `${IMG_URL}1.png`);
    } else if (val == 472) {
      $(".box_details_img1-po10").attr("src", `${IMG_URL}4.png`);
    } else if (val == 576) {
      $(".box_details_img1-po10").attr("src", `${IMG_URL}3.png`);
    } else if (val == 557) {
      $(".box_details_img1-po10").attr("src", `${IMG_URL}5.png`);
    }


    // Remove duplicated from values and add them in array
    if ($.inArray(val, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4, val5);
    ...
    // Then compare quantity of each values with selected values
    quantity = occurrencesOf(val, [val, val2, val3, val4, val5]);
    quantity2 = occurrencesOf(val2, [val, val2, val3, val4, val5]);
    quantity3 = occurrencesOf(val3, [val, val2, val3, val4, val5]);
    quantity4 = occurrencesOf(val4, [val, val2, val3, val4, val5]);
    quantity5 = occurrencesOf(val5, [val, val2, val3, val4, val5]);
    ...
    // Add all the selected in showButton function
    showButton(selected, selected2, selected3, selected4, selected5);
  });

  $("#2-po10").change(function () {
    val2 = $(this).val();

    if (val2 == 594) {
      $(".box_details_img2-po10").attr("src", `${IMG_URL}2.png`);
    } else if (val2 == 592) {
      $(".box_details_img2-po10").attr("src", `${IMG_URL}10.png`);
    } else if (val2 == 581) {
      $(".box_details_img2-po10").attr("src", `${IMG_URL}12.png`);
    } else if (val2 == 790) {
      $(".box_details_img2-po10").attr("src", `${IMG_URL}1.png`);
    } else if (val2 == 472) {
      $(".box_details_img2-po10").attr("src", `${IMG_URL}4.png`);
    } else if (val2 == 576) {
      $(".box_details_img2-po10").attr("src", `${IMG_URL}3.png`);
    } else if (val2 == 557) {
      $(".box_details_img2-po10").attr("src", `${IMG_URL}5.png`);
    }
  ...
  $("#3-po10").change(function () {
    val3 = $(this).val();

    if (val3 == 594) {
      $(".box_details_img3-po10").attr("src", `${IMG_URL}2.png`);
    } else if (val3 == 592) {
      $(".box_details_img3-po10").attr("src", `${IMG_URL}10.png`);
    } else if (val3 == 581) {
      $(".box_details_img3-po10").attr("src", `${IMG_URL}12.png`);
    } else if (val3 == 790) {
      $(".box_details_img3-po10").attr("src", `${IMG_URL}1.png`);
    } else if (val3 == 472) {
      $(".box_details_img3-po10").attr("src", `${IMG_URL}4.png`);
    } else if (val3 == 576) {
      $(".box_details_img3-po10").attr("src", `${IMG_URL}3.png`);
    } else if (val3 == 557) {
      $(".box_details_img3-po10").attr("src", `${IMG_URL}5.png`);
    }
  ...
  $("#4-po10").change(function () {
    val4 = $(this).val();

    if (val4 == 594) {
      $(".box_details_img4-po10").attr("src", `${IMG_URL}2.png`);
    } else if (val4 == 592) {
      $(".box_details_img4-po10").attr("src", `${IMG_URL}10.png`);
    } else if (val4 == 581) {
      $(".box_details_img4-po10").attr("src", `${IMG_URL}12.png`);
    } else if (val4 == 790) {
      $(".box_details_img4-po10").attr("src", `${IMG_URL}1.png`);
    } else if (val4 == 472) {
      $(".box_details_img4-po10").attr("src", `${IMG_URL}4.png`);
    } else if (val4 == 576) {
      $(".box_details_img4-po10").attr("src", `${IMG_URL}3.png`);
    } else if (val4 == 557) {
      $(".box_details_img4-po10").attr("src", `${IMG_URL}5.png`);
    }
  ...
  $("#5-po10").change(function () {
    val5 = $(this).val();

    if (val5 == 594) {
      $(".box_details_img5-po10").attr("src", `${IMG_URL}2.png`);
    } else if (val5 == 592) {
      $(".box_details_img5-po10").attr("src", `${IMG_URL}10.png`);
    } else if (val5 == 581) {
      $(".box_details_img5-po10").attr("src", `${IMG_URL}12.png`);
    } else if (val5 == 790) {
      $(".box_details_img5-po10").attr("src", `${IMG_URL}1.png`);
    } else if (val5 == 472) {
      $(".box_details_img5-po10").attr("src", `${IMG_URL}4.png`);
    } else if (val5 == 576) {
      $(".box_details_img5-po10").attr("src", `${IMG_URL}3.png`);
    } else if (val5 == 557) {
      $(".box_details_img5-po10").attr("src", `${IMG_URL}5.png`);
    }
  ...
  function addValuesToLink(selectedVal, selectedQuantity) {
    $("a#link-po10").attr(
      "href",
      `https://getawhey.in/cart/?add-to-cart=1483${
        val ? `&quantity[${val}]=${quantity * 2}` : ""
      }${val2 ? `&quantity[${val2}]=${quantity2 * 2}` : ""}${
        val3 ? `&quantity[${val3}]=${quantity3 * 2}` : ""
      }${val4 ? `&quantity[${val4}]=${quantity4 * 2}` : ""} ${
        val5 ? `&quantity[${val5}]=${quantity5 * 2}` : ""
      }
      `
    );
  }
...
// BYOP - House Party Pack

function byopHPP () {
  // On start addToCartButton should be hidden
  $("#addToCartButton-hPP").hide();

  // On Click of Button Show Select/Dropdown
  $(".select-product-hPP").click(function(){
    $("#1-hPP").css({"visibility": "visible"});
  });
  $(".select-product-hPP-2").click(function(){
    $("#2-hPP").css({"visibility": "visible"});
  });
  $(".select-product-hPP-3").click(function(){
    $("#3-hPP").css({"visibility": "visible"});
  });
  $(".select-product-hPP-4").click(function(){
    $("#4-hPP").css({"visibility": "visible"});
  });
  $(".select-product-hPP-5").click(function(){
    $("#5").css({"visibility": "visible"});
  });
  ...
  // Function to get value of each select field and apply it to href
  $("#1-hPP").change(function () {
    val = $(this).val();

    // Add image according to selected values
    if (val == 544) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}15.png`);
      } else if (val == 541) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}14.png`);
      } else if (val == 536) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}20.png`);
      } else if (val == 531) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}13.png`);
      } else if (val == 528) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}16.png`);
      } else if (val == 509) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}21.png`);
      } else if (val == 506) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}17.png`);
      } else if (val == 498) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}19.png`);
      } else if (val == 496) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}18.png`);
      } else if (val == 478) {
        $(".box_details_img1-hPP").attr("src", `${IMG_URL}22.png`);
      } 
    ...
    // On every select find the occurrence of value in selected values 
    setProducts(selectedVal, selectedQuantity);
    ...
    // Add all the selected in showButton function
    showButton(selected, selected2, selected3, selected4);
  });

  $("#2-hPP").change(function () {
    val2 = $(this).val();

    if (val2 == 544) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}15.png`);
      } else if (val2 == 541) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}14.png`);
      } else if (val2 == 536) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}20.png`);
      } else if (val2 == 531) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}13.png`);
      } else if (val2 == 528) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}16.png`);
      } else if (val2 == 509) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}21.png`);
      } else if (val2 == 506) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}17.png`);
      } else if (val2 == 498) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}19.png`);
      } else if (val2 == 496) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}18.png`);
      } else if (val2 == 478) {
        $(".box_details_img2-hPP").attr("src", `${IMG_URL}22.png`);
      } 
    if ($.inArray(val2, selectedVal) == -1)
      selectedVal.push(val, val2, val3, val4);
  ...
  $("#3-hPP").change(function () {
    val3 = $(this).val();

    if (val3 == 544) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}15.png`);
      } else if (val3 == 541) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}14.png`);
      } else if (val3 == 536) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}20.png`);
      } else if (val3 == 531) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}13.png`);
      } else if (val3 == 528) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}16.png`);
      } else if (val3 == 509) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}21.png`);
      } else if (val3 == 506) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}17.png`);
      } else if (val3 == 498) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}19.png`);
      } else if (val3 == 496) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}18.png`);
      } else if (val3 == 478) {
        $(".box_details_img3-hPP").attr("src", `${IMG_URL}22.png`);
      } 
  ...
  $("#4-hPP").change(function () {
    val4 = $(this).val();

    if (val4 == 544) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}15.png`);
      } else if (val4 == 541) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}14.png`);
      } else if (val4 == 536) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}20.png`);
      } else if (val4 == 531) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}13.png`);
      } else if (val4 == 528) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}16.png`);
      } else if (val4 == 509) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}21.png`);
      } else if (val4 == 506) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}17.png`);
      } else if (val4 == 498) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}19.png`);
      } else if (val4 == 496) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}18.png`);
      } else if (val4 == 478) {
        $(".box_details_img4-hPP").attr("src", `${IMG_URL}22.png`);
      } 
    ...
    // Function to compare quantity of each values with selected values
    function setProducts(selectedVal, selectedQuantity) {
        var occurrencesOf = (number, numbers) =>
          numbers.reduce(
            (counter, currentNumber) =>
              number === currentNumber ? counter + 1 : counter,
         ...
         // Compare quantity of each values with selected values  
        quantity = occurrencesOf(val, [val, val2, val3, val4]);
        quantity2 = occurrencesOf(val2, [val, val2, val3, val4]);
        quantity3 = occurrencesOf(val3, [val, val2, val3, val4]);
        quantity4 = occurrencesOf(val4, [val, val2, val3, val4]);
...
// Change Cart Page Url 
var pageTitle = document.title;
var nextURL = 'https://getawhey.in/cart/';
var nextTitle = 'Cart - Get-A-Whey';
const nextState = { additionalInformation: 'Updated the URL with JS' };
console.log(pageTitle)
 if(pageTitle == 'Cart - Get-A-Whey') {
if (window.event) {
 ...
 $(window).scroll(function (event) {
  if ($(window).scrollTop() <= 0) {
    $("#logo").attr("src","https://bridgekash.in/getawhey/wp-content/uploads/2022/02/logo2.png");
  } else {
    $("#logo").attr("src","https://bridgekash.in/getawhey/wp-content/uploads/2022/03/MicrosoftTeams-image-1.png");
  }
});